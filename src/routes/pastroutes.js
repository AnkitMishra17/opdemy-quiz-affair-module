...
router.get('/past-subject/', (req,res) =>{
...
router.get('/past-current-affairs/', (req,res) =>{
...
router.get('/past-GS-subjective/', (req,res) =>{
...
router.get('/past-current-affairs-subjective/', (req,res) =>{
